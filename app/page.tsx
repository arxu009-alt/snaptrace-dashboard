    ...
    <div className="min-h-screen bg-[#05070E] text-slate-100 font-sans selection:bg-yellow-400 selection:text-slate-950 overflow-x-hidden relative">
      ...
      <div className={
        ...
        <span className="hidden sm:inline">
          {marketingMode ? '• Only 10 seats left before Lifetime Access closes (No credit card needed)' : '• 0ms Hydration Penalty • <3.4KB Gzipped'}
        </span>
      </div>
      ...
      <header className="border-b border-slate-800/80 bg-[#090D16]/95 backdrop-blur-xl sticky top-0 z-40 transition-all">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between gap-6">
          ...
          <nav className="hidden lg:flex items-center space-x-1.5 text-xs font-bold text-slate-200 font-mono">
            ...
            >
              <button className="px-3.5 py-2 rounded-xl border border-transparent hover:border-yellow-400/80 hover:bg-yellow-400/15 hover:text-yellow-300 transition-all duration-200 flex items-center gap-1.5 cursor-pointer">
                <span>Platform</span>
            ...
            <div
              ...
              onMouseLeave={() => setOpenDropdown(null)}
            >
              <button className="px-3.5 py-2 rounded-xl border border-transparent hover:border-yellow-400/80 hover:bg-yellow-400/15 text-yellow-300 hover:text-yellow-200 transition-all duration-200 flex items-center gap-1.5 cursor-pointer">
                  ...
                  <div className="w-84 bg-[#0B101D] border border-slate-800 rounded-2xl shadow-2xl p-3.5 space-y-2 font-sans">
                    ...
                    <a href="#ai-agent" className="flex items-start gap-2.5 p-2 rounded-xl hover:bg-slate-800/60 transition">
                      ...
                      <div>
                        ...
                        <div className="text-[10px] text-slate-400">Export pre-formatted prompts for your IDE [1.4.1, 1.4.2]</div>
                      </div>
                    </a>
            ...
            <a href="#comparison" className="px-3.5 py-2 rounded-xl border border-transparent hover:border-yellow-400/80 hover:bg-yellow-400/15 hover:text-yellow-300 transition-all duration-200">
              Why SnapTrace
            </a>
            <a href="#pricing" className="px-3.5 py-2 rounded-xl border border-transparent hover:border-yellow-400/80 hover:bg-yellow-400/15 hover:text-yellow-300 transition-all duration-200 text-yellow-400">
              Pricing
            </a>
            <Link href="/about" className="px-3.5 py-2 rounded-xl border border-transparent hover:border-yellow-400/80 hover:bg-yellow-400/15 hover:text-yellow-300 transition-all duration-200">
              About
            </Link>
            <a href="#faq" className="px-3.5 py-2 rounded-xl border border-transparent hover:border-yellow-400/80 hover:bg-yellow-400/15 hover:text-yellow-300 transition-all duration-200">
              FAQ
            </a>
          </nav>
      ...
      {!marketingMode ? (
          ...
          <div className="max-w-5xl w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center pt-2">
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="space-y-2 text-xs font-mono text-slate-300 leading-relaxed">
                <p>
                  <strong>Why did we build this?</strong> Because legacy APMs became bloated and noisy [1.1.7, 1.2.2]. A single database pool timeout triggers 4 downstream HTTP crashes, and traditional trackers spam your inbox with 4 separate alerts that you have to piece together by hand on a Sunday [1.1.7].
                </p>
        ...
        <>
          ...
          <SmoothReveal className="max-w-5xl mx-auto px-6 pb-20" delay={100}>
            <div id="social-proof" className="p-6 rounded-3xl bg-gradient-to-r from-[#0B101D] to-[#080d1a] border border-slate-800 shadow-xl space-y-3">
              ...
              <table className="w-full text-left text-xs">
                ...
                <tbody className="divide-y divide-slate-800 text-slate-300 font-mono">
                  ...
                  <tr>
                    ...
                    <td className="p-4 text-slate-500">Noisy separate alerts [1.1.7]</td>
                    <td className="p-4 text-slate-500">✕ None</td>
                  </tr>
                  <tr>
                    <td className="p-4 font-semibold text-white">Free Tier Events</td>
                    <td className="p-4 text-emerald-400 font-bold">2,000 / month</td>
          ...
          {/* 🌟 10. RE-ENGINEERED 3-TIER PRICING SECTION */}
          <section id="pricing" className="max-w-7xl mx-auto px-6 pt-8 pb-16 border-t border-slate-800/80">
            <div className="bg-[#090D16]/90 border border-slate-800/80 rounded-3xl p-6 sm:p-10 backdrop-blur-xl shadow-2xl space-y-8">
              ...
              <SmoothReveal className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch max-w-6xl mx-auto" delay={150}>
                ...
                <div className="bg-gradient-to-b from-[#0e1424] to-[#070b14] border-2 border-yellow-400/60 rounded-3xl p-6 sm:p-7 space-y-6 shadow-2xl relative flex flex-col justify-between transform lg:-translate-y-2 hover:border-yellow-400 transition">
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2.5 text-xs text-slate-200 border-t border-slate-800/80 pt-5 font-mono">
                      ...
                      <li className="flex items-center gap-2"><span className="text-yellow-400 font-bold">✓</span> In-Dashboard BYOK AI Copilot</li>
                    </ul>
                  </div>
            ...
            <div className="max-w-5xl mx-auto px-6 text-center space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto text-xs font-mono">
                ...
                <div className="p-4 bg-[#0B101D] border border-slate-800 rounded-2xl space-y-1">
                  ...
                  <div className="text-[10px] text-slate-400">SHA-256 loop throttling [1.1.7]</div>
                </div>
                <div className="p-4 bg-[#0B101D] border border-slate-800 rounded-2xl space-y-1">
                  <span className="text-xl">🔓</span>
      ...
      {/* 🌟 IN-APP CONTACT MODAL FOR AGENCY STUDIO ACCESS ($49 TIER) */}
      {showAgencyModal && (
        <div
          onClick={(e) => {
        ...
        >
          <div className="bg-[#090D16] border-2 border-purple-500/40 rounded-3xl max-w-md w-full p-6 sm:p-7 space-y-5 shadow-2xl relative">
            <button
